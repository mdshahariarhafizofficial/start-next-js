...
<header className="p-4 dark:bg-gray-100 dark:text-gray-800">
	<div className="container flex justify-between h-16 mx-auto">
		...
		<ul className="items-stretch hidden space-x-3 lg:flex">
			...
			<li className="flex">
				<Link  href="/about" className="flex items-center px-4 -mb-1 border-b-2 dark:border-">About</Link>
			</li>
			<li className="flex">
				<Link  href="/services" className="flex items-center px-4 -mb-1 border-b-2 dark:border-">Services</Link>
			</li>
			<li className="flex">
				<Link  href="/about/aboutCar" className="flex items-center px-4 -mb-1 border-b-2 dark:border- dark:text-violet-600 dark:border-violet-600">About Car</Link>
			</li>			
		</ul>
